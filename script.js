...
function initPage() {
    ...
    function startExperience() {
        ...
        if (elements.profileBlock) {
            ...
            if (typeof gsap !== 'undefined') {
                gsap.fromTo(elements.profileBlock,
                    { opacity: 0, y: -50 },
                    { 
                        opacity: 1, 
                        y: 0, 
    ...
    function startBioTypewriter() {
        ...
        function typeBio() {
            ...
            elements.profileBio.textContent = bioState.text + (bioState.cursorVisible ? '|' : ' ');
    ...
    function setupVolumeControls() {
        if (!elements.volumeSlider || !elements.volumeIcon || !elements.video) return;
